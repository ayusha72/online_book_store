<?php
	...
	// connect database
	$conn = db_connect();
	$pubName = getauthorName($conn, $pubid);

	$query = "SELECT book_isbn, book_title, book_image FROM books WHERE book_author = '$pubid'";
	...
	if(mysqli_num_rows($result) == 0){
		echo "Empty books ! Please wait until restocked!";
		exit;
	}
...
?>
	<p class="lead"><a href="author_list.php">Authors</a> > <?php echo $pubName; ?></p>
